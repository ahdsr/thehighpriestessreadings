  ...
  <div class="bg-black">
    ...
    <div>
      ...
      <section
        ...
        class="fixed inset-x-0 bottom-0 z-10 block bg-black"
      >
        <div id="tabs" class="flex justify-between fill-current text-green-50">
          <a
            href="#"
          ...
          >
            ...
            <span class="block text-xs tab tab-kategori">Category</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-explore">Explore</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-whishlist">Whishlist</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-account">Account</span>
          </a>
        </div>
      </section>
    </div>
