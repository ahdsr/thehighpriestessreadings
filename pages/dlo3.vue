  ...
  <div class="antialiased">
    ...
    <div class="mt-4">
      <div
        class="p-4 mx-auto text-base font-bold text-gray-600 bg-gray-100 border-b-2"
      >
        <h3 class="text-base font-bold text-gray-600">Garaging Address</h3>
      </div>
      <div class="grid grid-cols-2 gap-4 p-4 mx-auto">
        <div>
          <p class="mt-1 text-sm font-semibold text-gray-900">Address Line 1</p>
          <p class="mt-0 text-sm text-gray-500">170700 E Independence St</p>
        </div>
        <!-- ... -->
        <div>
          <p class="mt-1 text-sm font-semibold text-gray-900">Address Line 2</p>
        ...
        <div>
          <p class="mt-1 text-sm font-semibold text-gray-900">County</p>
          <p class="mt-0 text-sm text-gray-500">Tulsa</p>
        </div>
        <!-- ... -->
        <div>
          <p class="mt-1 text-sm font-semibold text-gray-900">City</p>
    ...
    <div>
        ...
        <tbody>
          ...
          <tr class="bg-gray-50">
            ...
            <td class="px-2 py-2 text-sm text-gray-500">
              FCA US Fleet Puchase Allowance FCA IS National
            </td>
            <td class="px-2 py-2 text-sm text-gray-500">$1,200.23</td>
          </tr>
          <!-- Odd row -->
          <tr class="bg-white">
            <td class="px-2 py-2 text-sm font-medium text-gray-900 align-top">
            ...
            <td class="px-2 py-2 text-sm text-gray-500">$300.23</td>
          </tr>
          ...
          <tr class="bg-gray-50">
            ...
            <td class="px-2 py-2 text-sm text-gray-500">$2,330.00</td>
          </tr>
      ...
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody>
          ...
          <tr class="bg-white">
            ...
            <td class="px-2 py-2 text-sm text-gray-500">
              FCA US Fleet Puchase Allowance FCA IS National FCA US Fleet
              Puchase Allowance FCA IS National
            </td>
          </tr>
      ...
      <div>
        <h3 class="p-3 mx-auto -mb-5 text-lg font-bold text-element-dark-blue">
          Select your vehicle
        </h3>
