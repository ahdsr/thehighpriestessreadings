<template>
  <div class="antialiased">
    ...
    <div class="mt-20">
      <div
        class="fixed inset-x-0 bottom-0 block h-16 pt-3 pr-2 align-middle shadow-xl z-5"
      >
    ...
    >
      ...
      >
        <div class="relative flex items-center space-x-4">
          <img
            src="https://www.elementfleet.com/binaries/content/gallery/elementfleet/hero/hero-1480x833-blurry-nighttime-street-min.jpg/hero-1480x833-blurry-nighttime-street-min.jpg/elementfleet%3Aherolarge"
            alt="My profile"
    ...
    <div class="w-full h-screen">
      ...
      <section
        ...
        class="fixed inset-x-0 bottom-0 z-10 block bg-white"
      >
        <div id="tabs" class="flex justify-between">
          ...
          >
            ...
            <span class="block text-xs tab tab-kategori">Milage</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-explore">Service Card</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-whishlist">Find Service</span>
          </a>
          <a
            href="#"
            class="justify-center inline-block w-full pt-2 pb-1 text-center focus:text-teal-500 hover:text-teal-500"
          >
            ...
            <span class="block text-xs tab tab-account">More</span>
          </a>
        </div>
      </section>
    </div>
